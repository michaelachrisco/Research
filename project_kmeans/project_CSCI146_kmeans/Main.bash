...
then
	...
	then
		...
		then 
			...
			rm -rf MASTER_BOW
			rm -rf AI
			mkdir Documents_BOW MASTER MASTER_BOW AI
...
#STEP 1: create sample data set 
#data is already stored in documents
...
do
  ...
  sh bag_of_words_with_occurances.bash $f $BOW_PATH"document"$temp"_BOW.txt"
...
cat $BOW_PATH*|sort > $MASTER_PATH"MASTER.txt"
